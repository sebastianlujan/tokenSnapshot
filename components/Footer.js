  ...
  return (
    <div className="grid justify-center w-full h-full pt-20 bg-black p-30">
        ...
        <div className='bg-img'>
          ...
          <div className='flex justify-between pt-32 pb-16 text-white'>
            <Link href='https://etherscan.io/address/0xfd3fd9b793bac60e7f0a9b9fb759db3e250383cb'><a className='underline hover' target='_blank'>Review the Smart Contract.</a></Link>
